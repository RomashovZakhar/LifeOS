...
**Дата:** 2026-07-19  
**Статус:** черновик на апрув (Q1–Q4 закрыты §10)  
**Язык UI:** русский  

Полноценный модуль тренировок за колонкой-порталом Habits.  
Не Strong / не Apple Health: сессия дня, подходы, шаблоны, «прошлый раз», секундомер → длительность в сетке.
...
3. Сетка Habits только **проецирует** `durationSeconds` completed-сессии.  
...
| **C** Completed | status=completed | Показана длительность (tap → edit duration sheet) | нет «Начать» | «+ Упражнение»; правка подходов; **Удалить тренировку** в ⋯ или danger внизу |
...
5. Habits cell обновляется проекцией.
...
| С | Как |
|---|-----|
| Habits grid | duration projection; жесты входа из 05 |
