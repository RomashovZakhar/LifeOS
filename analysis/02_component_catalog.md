...
- **Назначение:** визуально выделить выбранный / сегодняшний день.
- **Анатомия:** красный rounded square/pill вокруг номера дня; часто + тёплая полупрозрачная полоса на всю строку (split/selected).
