...
| `color.accent`               | Selected/today day badge; mini calendar day                        | **`#FA373B`** (рабочий якорь; сэмпл ~`rgb(250,55,59)`, рядом `#FC3E40`) | **Зафиксировано** — красный эталона (§17) |
...
| Selected day: `color.accent` badge + optional `accent.soft` row wash | A     |
